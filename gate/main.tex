...
\end{table}
\begin{align}
Number of tests initially to examine each group &= $a$ \\ &=200
\end{align}
\\ \\ 
\textbf{Worst case Scenario} \\ 
There will be 100 groups who will test positive( one positive in each group ).\\
Now, for these 100 groups:
We will test the 5 individuals in that group separately.
\begin{align}
Number of tests in each positive group &= 5 \\
\end{align}
\begin{align}
Number of more tests &= $b$ \\ &= 5 * 100 \\
&= 500
\end{align}
\begin{align}
\therefore Total tests &= $a$ + $b$ \\ &= 200 + 500 \\ &= 700
\end{align}
